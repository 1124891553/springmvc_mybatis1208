...
public class ItemsController {
	...
	public Map<String, String> getItemTypes() throws Exception {
		...
		List<ItemsCustom> list = itemsService.findItemscategoryList();
		
		for(ItemsCustom itemsCustom : list){
			itemTypes.put(itemsCustom.getCategory(),itemsCustom.getCategory());
		}
	...
	public ModelAndView queryItems(HttpServletRequest request,
			ItemsQueryVo itemsQueryVo,ItemsCustom itemsCustom) throws Exception {
...
//		}
	...
	public String insertItemsSubmit(Items items,MultipartFile items_pic) throws Exception{
	...
	@RequestMapping("/insertItemsSubmit1")
	public String insertItemsSubmit1(Items items) throws Exception{
